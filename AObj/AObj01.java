...
public class AObj01 {
	...
	public static void main(String[] args) {
		...
		// I tried to make a non-static variable and add it to the println, but kept getting the error, "Cannot make a static reference to the non-static field AObj01.x".
		// i.e.:
		//System.out.println("i=" + i + "  c=>" + c + "<" + AObj01.x);
